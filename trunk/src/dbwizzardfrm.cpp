...
mysqsqlcreatelist << "INSERT INTO `doctab` VALUES (1,'1 offer','','0001',''),(2,'2 orderconf','','0001',''),(3,'3 deliverynote','/','0001',''),(4,'4 invoice','','0002','');";
...
mysqsqlcreatelist << "INSERT INTO `maincfgtab` VALUES ('','docfolder',''),('','dbversion','"+firstver+"'),('','company','"+txtcompany->text()+"'),('','companyaddress','"+txtstreetnr->text()+"'),('','bankname',''),('','bankaddress',''),('','bankblz',''),('',,'bankaccountnr',''),(10,'banktnr',''),(11,'docpref',''),(12,'DoG',''),('','tool_lnx_dvi2ps','dvips'),('','tool_lnx_dviview','kdvi'),('','tool_lnx_print','kprint'),('','tool_lnx_tex2dvi','latex');";
mysqsqlcreatelist << "UNLOCK TABLES;";
