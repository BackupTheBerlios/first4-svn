...
mysqsqlcreatelist << "CREATE TABLE `accounts` (`ID` int(11) NOT NULL auto_increment,`name` text NOT NULL,`description` text NOT NULL,`accountnr` text NOT NULL,`bank` text NOT NULL,`blz` text NOT NULL,`currency` text NOT NULL,`users` text NOT NULL, PRIMARY KEY  (`ID`)) ENGINE=InnoDB DEFAULT CHARSET=latin1;";
mysqsqlcreatelist << "INSERT INTO accounts VALUES ('','incexp', 'Incomes / Expenditures','','','','','');";
mysqsqlcreatelist << "INSERT INTO accounts VALUES ('','incexparchive', 'Archive','','','','','');";
...
mysqsqlcreatelist << "CREATE TABLE `documentpositions` (`ID` int(11) auto_increment,`DOCID` text,`STOCK` text,`STOCK_ID` text,`DOC_POSITION` int(11) default '0',`LABEL` text,`DESCRIPTION` text,`QUANTITY` float default '0',`UNIT` text,`PRICE` float default '0',`VAT` float default '0',`TYPE` char(10) default NULL,PRIMARY KEY  (`ID`)) ENGINE=InnoDB DEFAULT CHARSET=latin1;";
...
mysqsqlcreatelist << "CREATE TABLE `documentcfg` (`ID` int(11) NOT NULL auto_increment,`name` text NOT NULL,`filename` text NOT NULL,`count` text NOT NULL,`users` text NOT NULL,PRIMARY KEY  (`ID`)) ENGINE=InnoDB DEFAULT CHARSET=latin1;";
...
mysqsqlcreatelist << "UNLOCK TABLES;";
mysqsqlcreatelist << "CREATE TABLE `procedureorders` (`ID` int(11) NOT NULL auto_increment,`PROC_ID` text,`STOCK` text,`STOCK_ID` text,`STATE` char(1) default '0',`LABEL` text,`DESCRIPTION` text,`QUANTITY` float default '0',`UNIT` text,`PRICE` float default '0',`VAT` float default '0',PRIMARY KEY  (`ID`)) ENGINE=InnoDB DEFAULT CHARSET=latin1;";
